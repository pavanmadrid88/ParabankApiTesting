...
public class BillPayService extends BaseService {
    ...
    public void billPayShouldBeSuccessful(String amount, String payeeName) {
        try {
            ...
            logger.error("Exception while validating bill pay:" + e.getMessage());
            Assert.fail("Exception while validating bill pay:" + e.getMessage());
        }
    }
    ...
    public void billPay(String amount, String payeeName, String payeeAddressStreet, String payeeAddressCity, String payeeAddressState, String payeeAddressZipcode, String payeePhoneNumber) {
        try {
            ...
            logger.error("Exception while bill pay:" + e.getMessage());
            Assert.fail("Exception while bill pay:" + e.getMessage());
        }
    }
}
